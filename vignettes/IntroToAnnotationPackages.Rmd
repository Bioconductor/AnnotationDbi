...
```{r dbtypes, fig.cap = "Annotation Packages: the big picture", echo = FALSE, out.width = '60%'}
...
Interfaces for custom Annotation resources" from the `r
Biocpkg("AnnotationForge")` package.
