...
setGeneric("from.colpos", function(x) standardGeneric("from.colpos"))
setGeneric("to.colpos", function(x) standardGeneric("to.colpos"))
setGeneric("fromCol", function(x) standardGeneric("fromCol"))
setGeneric("toCol", function(x) standardGeneric("toCol"))
setGeneric("tagCol", function(x) standardGeneric("tagCol"))
