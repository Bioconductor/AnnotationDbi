...
setGeneric("toTable", signature="x", function(x) standardGeneric("toTable"))
...
setGeneric("fromCol", signature="x", function(x) standardGeneric("fromCol"))
setGeneric("toCol", signature="x", function(x) standardGeneric("toCol"))
setGeneric("tagCol", signature="x", function(x) standardGeneric("tagCol"))
setGeneric("toLList", signature="x", function(x) standardGeneric("toLList"))
setGeneric("toRList", signature="x", function(x) standardGeneric("toRList"))
