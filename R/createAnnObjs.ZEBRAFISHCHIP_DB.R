...
### ZEBRAFISHCHIP_DB-based package i.e. any SQLite-based ann data package based
### on the ZEBRAFISHCHIP_DB schema.
### The createAnnObjs.ZEBRAFISHCHIP_DB() function is the main entry point for
### this file: it is called by any ZEBRAFISHCHIP_DB-based package at load-time.
### -------------------------------------------------------------------------

orgPkg = "org.Dr.eg"

ZEBRAFISHCHIP_DB_L2Rlink1 <- list(tablename="probes", Lcolname="probe_id", Rcolname="gene_id", filter="{is_multiple}='0'")
ZEBRAFISHCHIP_DB_L2Rlink2 <- list(tablename="genes", Lcolname="gene_id", Rcolname="_id", altDB=orgPkg)

### Mandatory fields: objName, Class and L2Rchain
ZEBRAFISHCHIP_DB_AnnDbBimap_seeds <- list(
    list(
        objName="ACCNUM",
    ...
    list(
        ...
        Class="ProbeAnnDbBimap",
        L2Rchain=list(
            ZEBRAFISHCHIP_DB_L2Rlink1,
            ZEBRAFISHCHIP_DB_L2Rlink2,
            list(
                tablename="alias",
                Lcolname="_id",
...
createAnnObjs.ZEBRAFISHCHIP_DB <- function(prefix, objTarget, dbconn, datacache)
{
    checkDBSCHEMA(dbconn, "ZEBRAFISHCHIP_DB")
    ...
    ann_objs <- createAnnDbBimaps(ZEBRAFISHCHIP_DB_AnnDbBimap_seeds, seed0)
    ...
    ann_objs$CHRLENGTHS <- createCHRLENGTHS(dbconn, dbname="org.Dr.eg")
    ann_objs$MAPCOUNTS <- createMAPCOUNTS(dbconn, prefix)
    ## 1 special string to let us know who the supporting org package is.
    ann_objs$ORGPKG <- "org.Dr.eg"
