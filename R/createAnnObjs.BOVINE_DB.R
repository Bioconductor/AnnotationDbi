...
### BOVINE_DB-based package i.e. any SQLite-based ann data package based
### on the BOVINE_DB schema.
### The createAnnObjs.BOVINE_DB() function is the main entry point for
### this file: it is called by any BOVINE_DB-based package at load-time.
### -------------------------------------------------------------------------


BOVINE_DB_L2Rlink1 <- list(tablename="genes", Lcolname="gene_id", Rcolname="_id")

### Mandatory fields: objName, Class and L2Rchain
BOVINE_DB_AnnDbBimap_seeds <- list(
    list(
        objName="ACCNUM",
        Class="AnnDbBimap",
        L2Rchain=list(
...
createAnnObjs.BOVINE_DB <- function(prefix, objTarget, dbconn, datacache)
{
    checkDBSCHEMA(dbconn, "BOVINE_DB")
    ...
    ann_objs <- createAnnDbBimaps(BOVINE_DB_AnnDbBimap_seeds, seed0)
