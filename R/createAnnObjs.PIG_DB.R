...
### PIG_DB-based package i.e. any SQLite-based ann data package based
### on the PIG_DB schema.
### The createAnnObjs.PIG_DB() function is the main entry point for
### this file: it is called by any PIG_DB-based package at load-time.
### -------------------------------------------------------------------------


PIG_DB_L2Rlink1 <- list(tablename="genes", Lcolname="gene_id", Rcolname="_id")

### Mandatory fields: objName, Class and L2Rchain
PIG_DB_AnnDbBimap_seeds <- list(
    list(
        objName="ACCNUM",
        Class="AnnDbBimap",
        L2Rchain=list(
...
createAnnObjs.PIG_DB <- function(prefix, objTarget, dbconn, datacache)
{
    checkDBSCHEMA(dbconn, "PIG_DB")
    ...
    ann_objs <- createAnnDbBimaps(PIG_DB_AnnDbBimap_seeds, seed0)
