...
### XENOPUS_DB-based package i.e. any SQLite-based ann data package based
### on the XENOPUS_DB schema.
### The createAnnObjs.XENOPUS_DB() function is the main entry point for
### this file: it is called by any XENOPUS_DB-based package at load-time.
### -------------------------------------------------------------------------


XENOPUS_DB_L2Rlink1 <- list(tablename="genes", Lcolname="gene_id", Rcolname="_id")

### Mandatory fields: objName, Class and L2Rchain
XENOPUS_DB_AnnDbBimap_seeds <- list(
    list(
        objName="ACCNUM",
        Class="AnnDbBimap",
        L2Rchain=list(
...
createAnnObjs.XENOPUS_DB <- function(prefix, objTarget, dbconn, datacache)
{
    checkDBSCHEMA(dbconn, "XENOPUS_DB")
    ...
    ann_objs <- createAnnDbBimaps(XENOPUS_DB_AnnDbBimap_seeds, seed0)
