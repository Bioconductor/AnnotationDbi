...
### ANOPHELES_DB-based package i.e. any SQLite-based ann data package based
### on the ANOPHELES_DB schema.
### The createAnnObjs.ANOPHELES_DB() function is the main entry point for
### this file: it is called by any ANOPHELES_DB-based package at load-time.
### -------------------------------------------------------------------------


ANOPHELES_DB_L2Rlink1 <- list(tablename="genes", Lcolname="gene_id", Rcolname="_id")

### Mandatory fields: objName, Class and L2Rchain
ANOPHELES_DB_AnnDbBimap_seeds <- list(
    list(
        objName="ACCNUM",
        Class="AnnDbBimap",
        L2Rchain=list(
            ANOPHELES_DB_L2Rlink1,
            list(
...
createAnnObjs.ANOPHELES_DB <- function(prefix, objTarget, dbconn, datacache)
{
    checkDBSCHEMA(dbconn, "ANOPHELES_DB")
    ...
    ann_objs <- createAnnDbBimaps(ANOPHELES_DB_AnnDbBimap_seeds, seed0)
