...
### WORM_DB-based package i.e. any SQLite-based ann data package based
### on the WORM_DB schema.
### The createAnnObjs.WORM_DB() function is the main entry point for
### this file: it is called by any WORM_DB-based package at load-time.
### -------------------------------------------------------------------------


WORM_DB_L2Rlink1 <- list(tablename="genes", Lcolname="gene_id", Rcolname="_id")

### Mandatory fields: objName, Class and L2Rchain
WORM_DB_AnnDbBimap_seeds <- list(
    list(
        objName="ACCNUM",
        Class="AnnDbBimap",
        L2Rchain=list(
...
createAnnObjs.WORM_DB <- function(prefix, objTarget, dbconn, datacache)
{
    checkDBSCHEMA(dbconn, "WORM_DB")
    ...
    ann_objs <- createAnnDbBimaps(WORM_DB_AnnDbBimap_seeds, seed0)
