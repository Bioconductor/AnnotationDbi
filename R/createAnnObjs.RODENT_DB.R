...
### RODENT_DB-based package i.e. any SQLite-based ann data package based
### on the RODENT_DB schema.
### The createAnnObjs.RODENT_DB() function is the main entry point for
### this file: it is called by any RODENT_DB-based package at load-time.
### -------------------------------------------------------------------------


RODENT_DB_L2Rbrick1 <- list(tablename="genes", Lcolname="gene_id", Rcolname="id")
