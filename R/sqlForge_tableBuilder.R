...
##   sqliteQuickSQL(db, sql)
  ...
  count = makeMapCounts(db, "ACCNUM","accession","accessions","","WHERE accession NOT NULL")
...
##   sqliteQuickSQL(db, sql)
  ...
  makeMapCounts(db, paste("PMID2",subStrs[["suffix"]],sep=""),"pubmed_id","pubmed")
...
##   sqliteQuickSQL(db, sql)  
  ...
  makeMapCounts(db, paste("PATH2",subStrs[["suffix"]],sep=""),"path_id","kegg")
...
##   sqliteQuickSQL(db, sql)
  ...
  makeMapCounts(db, paste("ENZYME2",subStrs[["suffix"]],sep=""),"ec_number","ec")
...
##   sqliteQuickSQL(db, sql)  
  ...
  makeMapCounts(db, paste("ENSEMBLTRAN2",subStrs[["suffix"]],sep=""),"trans_id","ensembl_trans AS e", paste(subStrs[["cntrTab"]],"AS g"),"WHERE e._id=g._id")
