...
### RAT_DB-based package i.e. any SQLite-based ann data package based
### on the RAT_DB schema.
### The createAnnObjs.RAT_DB() function is the main entry point for
### this file: it is called by any RAT_DB-based package at load-time.
### -------------------------------------------------------------------------


RAT_DB_L2Rlink1 <- list(tablename="genes", Lcolname="gene_id", Rcolname="_id")

### Mandatory fields: objName, Class and L2Rchain
RAT_DB_AnnDbBimap_seeds <- list(
    list(
        objName="ACCNUM",
        Class="AnnDbBimap",
        L2Rchain=list(
...
createAnnObjs.RAT_DB <- function(prefix, objTarget, dbconn, datacache)
{
    checkDBSCHEMA(dbconn, "RAT_DB")
    ...
    ann_objs <- createAnnDbBimaps(RAT_DB_AnnDbBimap_seeds, seed0)
