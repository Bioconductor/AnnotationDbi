...
### PIGCHIP_DB-based package i.e. any SQLite-based ann data package based
### on the PIGCHIP_DB schema.
### The createAnnObjs.PIGCHIP_DB() function is the main entry point for
...
{
    checkDBSCHEMA(dbconn, "PIGCHIP_DB")
