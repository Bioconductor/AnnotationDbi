...
### INPARANOIDMUSMU_DB-based package i.e. any SQLite-based ann data package
### based on the INPARANOIDMUSMU_DB schema.
### The createAnnObjs.INPARANOIDMUSMU_DB() function is the main entry point
### for this file: it is called by any INPARANOIDMUSMU_DB-based package at
### load-time.
### -------------------------------------------------------------------------
...
createAnnObjs.INPARANOIDMUSMU_DB <- function(prefix, objTarget, dbconn, datacache)
{
    ...
    INPARANOIDMUSMU_DB_AnnDbBimap_seeds <- makeSeedList(species, fields)

    checkDBSCHEMA(dbconn, "INPARANOIDMUSMU_DB")
    ...
    ann_objs <- createAnnDbBimaps(INPARANOIDMUSMU_DB_AnnDbBimap_seeds, seed0)
