...
### CANINE_DB-based package i.e. any SQLite-based ann data package based
### on the CANINE_DB schema.
### The createAnnObjs.CANINE_DB() function is the main entry point for
### this file: it is called by any CANINE_DB-based package at load-time.
### -------------------------------------------------------------------------


CANINE_DB_L2Rlink1 <- list(tablename="genes", Lcolname="gene_id", Rcolname="_id")

### Mandatory fields: objName, Class and L2Rchain
CANINE_DB_AnnDbBimap_seeds <- list(
    list(
        objName="ACCNUM",
        Class="AnnDbBimap",
        L2Rchain=list(
...
{
    checkDBSCHEMA(dbconn, "CANINE_DB")
    ...
    ann_objs <- createAnnDbBimaps(CANINE_DB_AnnDbBimap_seeds, seed0)
