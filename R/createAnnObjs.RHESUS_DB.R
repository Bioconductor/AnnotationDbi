...
### RHESUS_DB-based package i.e. any SQLite-based ann data package based
### on the RHESUS_DB schema.
### The createAnnObjs.RHESUS_DB() function is the main entry point for
### this file: it is called by any RHESUS_DB-based package at load-time.
### -------------------------------------------------------------------------


RHESUS_DB_L2Rlink1 <- list(tablename="genes", Lcolname="gene_id", Rcolname="_id")

### Mandatory fields: objName, Class and L2Rchain
RHESUS_DB_AnnDbBimap_seeds <- list(
    list(
        objName="ACCNUM",
        Class="AnnDbBimap",
        L2Rchain=list(
...
createAnnObjs.RHESUS_DB <- function(prefix, objTarget, dbconn, datacache)
{
    checkDBSCHEMA(dbconn, "RHESUS_DB")
    ...
    ann_objs <- createAnnDbBimaps(RHESUS_DB_AnnDbBimap_seeds, seed0)
