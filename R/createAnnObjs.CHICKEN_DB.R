...
### CHICKEN_DB-based package i.e. any SQLite-based ann data package based
### on the CHICKEN_DB schema.
### The createAnnObjs.CHICKEN_DB() function is the main entry point for
### this file: it is called by any CHICKEN_DB-based package at load-time.
### -------------------------------------------------------------------------


CHICKEN_DB_L2Rlink1 <- list(tablename="genes", Lcolname="gene_id", Rcolname="_id")

### Mandatory fields: objName, Class and L2Rchain
CHICKEN_DB_AnnDbBimap_seeds <- list(
    list(
        objName="ACCNUM",
        Class="AnnDbBimap",
        L2Rchain=list(
...
createAnnObjs.CHICKEN_DB <- function(prefix, objTarget, dbconn, datacache)
{
    checkDBSCHEMA(dbconn, "CHICKEN_DB")
    ...
    ann_objs <- createAnnDbBimaps(CHICKEN_DB_AnnDbBimap_seeds, seed0)
