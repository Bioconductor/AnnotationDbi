...
### INPARANOIDHOMSA_DB-based package i.e. any SQLite-based ann data package
### based on the INPARANOIDHOMSA_DB schema.
### The createAnnObjs.INPARANOIDHOMSA_DB() function is the main entry point
### for this file: it is called by any INPARANOIDHOMSA_DB-based package at
### load-time.
### -------------------------------------------------------------------------
...
createAnnObjs.INPARANOIDHOMSA_DB <- function(prefix, objTarget, dbconn, datacache)
{
    ...
    INPARANOIDHOMSA_DB_AnnDbBimap_seeds <- makeSeedList(species, fields)

    checkDBSCHEMA(dbconn, "INPARANOIDHOMSA_DB")
    ...
    ann_objs <- createAnnDbBimaps(INPARANOIDHOMSA_DB_AnnDbBimap_seeds, seed0)
