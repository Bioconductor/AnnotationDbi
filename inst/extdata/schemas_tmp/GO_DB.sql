...
CREATE INDEX F1go_cc_parents on go_bp_parents (term_id);
CREATE INDEX F2go_cc_parents on go_bp_parents (parent_id);
CREATE INDEX F1go_mf_parents on go_bp_parents (term_id);
CREATE INDEX F2go_mf_parents on go_bp_parents (parent_id);
CREATE INDEX F1go_bp_offspring on go_bp_offspring (term_id);
CREATE INDEX F2go_bp_offspring on go_bp_offspring (offspring_id);
CREATE INDEX F1go_cc_offspring on go_bp_offspring (term_id);
CREATE INDEX F2go_cc_offspring on go_bp_offspring (offspring_id);
CREATE INDEX F1go_mf_offspring on go_bp_offspring (term_id);
CREATE INDEX F2go_mf_offspring on go_bp_offspring (offspring_id);
