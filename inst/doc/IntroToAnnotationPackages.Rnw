...
\Rmethod{keytypes} and \Rmethod{select}.  The following exercise
should acquaint you with these methods.
...
So how could you use select to annotate your results?  Please run the
following code snippet (which will load a fake data result that I have
