...
%\VignetteDepends{Biobase, AnnotationDbi}
...
First, let us load the \Rpackage{AnnotationDbi} package.
%
...
subdirectory of the \Rpackage{AnnotationDbi} package.

<<makeprobepackage, eval=FALSE>>=
...
within the package \Rpackage{AnnotationDbi}.  To facilitate the
