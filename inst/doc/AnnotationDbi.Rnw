%\VignetteIndexEntry{AnnotationDbi: How to use the ".db" annotation packages}
...
\title{AnnotationDbi: How to use the ".db" annotation packages}
...
rs = ls(revmap(org.Hs.egREFSEQ))[1:3]
