%\VignetteIndexEntry{AnnotationDbi: How to use bimaps from the ".db" annotation packages}
...
\title{AnnotationDbi: How to use bimaps from the ".db" annotation packages}
